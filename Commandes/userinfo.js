...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size > 1) {
    message.channel.send("Veuillez ne mentionner qu'un seul utilisateur.");
  } else if (message.mentions.users.size === 0) {
    const embed = new Discord.RichEmbed()
    .setTitle("Informations de l'utilisateur")
    .setDescription("Information pour " + message.author.username)
    ...
    .addField("Date de création du compte",
  ...
  const embed = new Discord.RichEmbed()
  .setTitle("Informations de l'utilisateur")
  .setDescription("Information pour " + message.mentions.users.first().username)
